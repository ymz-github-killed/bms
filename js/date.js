...
function fHideCalendar(){
  ...
  for (i in goSelectTag)
  	if(goSelectTag[i] && goSelectTag[i].style)
...
with (document) {
write("<Div id='VicPopCal' onclick='event.cancelBubble=true' style='POSITION:absolute;visibility:hidden;border:0px ridge;width:10;z-index:100;'>");

...
<script type="text/javascript">
		function beforeSubmit(){
			...
			if(confirm("是否确认删除，删除后将不可恢复！")){
				document.form1.action= "${pageContext.request.contextPath}/bms/adm/bmsuser/importDele.do";
...
<div class="barnavtop">您所在的位置：系统管理 >用户导入删除</div>
<div style="float:left;width:100%;">
	<!--主体 开始-->
    <div id="container" style="position:relative;">   
    <div class="toolbar">
       	<a href="${pageContext.request.contextPath}/bms/adm/deleExport.jsp" class="sexybutton" ><span><span>导出删除模版</span></span></a> 
    </div>
    <div id="searchForm">
        ...
        <ol>
        	<li style="background:none">
                ...
                1、请选择需要上传的文件<br>2、文件必须严格按照顺序填写<br>3、文件中登录名为必填项
</span>           
              </div>
         ...
         <div class="toolbar">
       	<a href="#" class="sexybutton" onclick="beforeSubmit();return false"><span><span>导入删除</span></span></a> 
        </div>
        <!--searchForm 开始-->
        <div id="searchForm">

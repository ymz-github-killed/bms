...
<script type="text/javascript">
			...
			{
				hideframe.location.href="${pageContext.request.contextPath}/bms/adm/bmswebapp/deleteBmsWebapp.do";
			}	
		</script>
<body class="overfwidth">

<div class="barnavtop">您所在的位置：系统管理 > 外部应用 > 删除外部应用</div>
<div id="workspace">
	<!--主体 开始-->
    <div id="container">    
        <div class="overf pt5 pb5">
            ...
            <span class="left ml10"><a class="sexybutton" href="${pageContext.request.contextPath}/bms/adm/bmswebapp/queryBmsWebapp.do"><span><span>返回</span></span></a></span>
        </div>
        <!--searchForm 结束-->
        <!--CmsSiteList 开始-->

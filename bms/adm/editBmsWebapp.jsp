...
<script type="text/javascript">
		...
		{	
			...
			str[0]=['auditClsname_','应用编码',255,1];
...
<div class="barnavtop">您所在的位置：系统管理 > 外部应用 > 编辑外部应用</div>
<div id="workspace">
	<!--主体 开始-->
    <div id="container">
    	<!--按钮 开始-->  
<div class="toolbar">
        ...
        <a href="${pageContext.request.contextPath}/bms/adm/bmswebapp/queryBmsWebapp.do" class="sexybutton"><span><span>返回</span></span></a>        </div>
        <!--按钮 结束-->  
        <!--框内内容 开始-->
          <div class="editspace">
                ...
                <ol>
                  <li class="listyle_4">
                    ...
                    <h1 class="cmxformh1"> <span class="cmxformspan">
                      <input id="auditClsname_" type="text" name="appCode" class="bgw" value="${m.appCode}" readonly="readonly"/>
                    </span></h1>
                  <li class="listyle_4">
                    <label class="left pt5"><em>*</em>应用名称：</label>
                    <h1 class="cmxformh1"> <span class="cmxformspan">
                      <input id="appName_" type="text" name="appName" class="bgw" value="${m.appName}" />
                    </span></h1>
                  </li>
                 <li class="listyle_4">
                    <label class="mt5 left bordernone"><em>*</em>URL链接：</label>
                    <h1 class="cmxformh1"> <span class="cmxformspan">
                      <input id="appUrl_" type="text" name="appUrl" class="wid350" value="${m.appUrl}" />
                    </span></h1>
                  </li>
                 <li class="listyle_4 bordernone" style="background:none;">
                    <label class="left pt5">简介：</label>
                    <textarea id="appDesc_" name="appDesc" cols="80" rows="3">${m.appDesc}</textarea>
                  </li>
                  </ol>
               </fieldset>
               <fieldset>
                  ...
                  <ol>
                     <li class="listyle_4">
                        ...
                        <h1 class="cmxformh1"> <span class="cmxformspan">
                        <input id="desKey_" type="password" name="desKey" class="wid350" value="${m.desKey}" />
                        <span style="color: gray;font-size: 12px">密码长度8位</span></span></h1>
                      </li>
                      <li class="listyle_4">
                        <label class="mt5 left bordernone">接入IP：</label>
                        <h1 class="cmxformh1"> <span class="cmxformspan">
                          <input id="appIp_" type="text" name="appIp" class="wid350" value="${m.appIp}" />

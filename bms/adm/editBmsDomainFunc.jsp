...
<div id="mainDiv">
<div class="barnavtop">您所在的位置：系统管理 > 数据权限 > 编辑数据权限</div>
	<!--主体 开始-->
    <div id="container">
    	<!--按钮 开始-->  
      <div class="toolbar">
              ...
              <fieldset>
                ...
                <ol>
                  <li class="listyle_4">
                    ...
                    <label class="left pt5">权限编码：</label>
                    <h1 class="cmxformh1"> <span class="cmxformspan">
                      <input type="text" id="code_" class="bgw" name="code" readonly="readonly" value="${m.code}" />
                    </span></h1>
                  </li>
                </ol>
                <!--ol 开始-->
                <ol>
                  <li class="listyle_4">
                    ...
                    <h1 class="cmxformh1"> <span class="cmxformspan">
                      <input type="text" id="datafuncName_" class="bgw" name="datafuncName" value="${m.datafuncName}" />
                    </span></h1>
                  </li>
                  <li class="listyle_4">
                    <label class="left pt5"><em>*</em>所属字典：</label>
                    <h1 class="cmxformh1"> <span class="cmxformspan">
                      <input id="domainname_" type="text" class="bgw" disabled="disabled" name="domainname" value="${m.tbTBmsDomainDTO.remark}" readonly="readonly"/>
                  ...
                  <li class="listyle_4">
                    ...
                    <h1 class="cmxformh1"> <span class="cmxformspan">
                      <input id="funcName_" type="text" class="bgw" disabled="disabled" name="funcName" value="${m.tbTBmsRscFuncDTO.name}" readonly="readonly"/>
                  ...
                  <li class="listyle_4">
                    ...
                    <!--  input type="radio"  name="radio" value="1">
                      ...
                      否  -->
                      <c:choose >
                        		<c:when test="${m.tbTBmsDomainDTO.valueType=='LIST'}">列表</c:when>
                ...
                <ol>
                  <li class="listyle_4 bordernone">
                    ...
                    <textarea name="desc" id="desc_" cols="80" rows="3">${m.desc}</textarea>
                  </li>
...
<div id="domainDiv"  style="display: none; text-align: center;height: 300px">
			<iframe id="selFrameDomain" width="100%" height="450px;" frameborder="0" scrolling="auto"></iframe>
		</div>

...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="25" bgcolor="#DDFAFE">&nbsp;&nbsp;<span class="font_blue_title">您所在的位置：用户管理子系统 &gt; 机构管理</span> <span class="font_blue_title">&gt; 增加机构</span></td>
      </tr>
    </table></td>
  </tr>
</table>
  ...
  <tr>
    ...
    <td width="99%" valign="top">
      ...
      <table width="98%"  border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#dfdfdf">
        <form name="frmApply" action="${pageContext.request.contextPath}/bms/adm/bmsdept/addBmsDept.do" target="hideframe" method="post" onsubmit="return beforeSubmit(this);">
          <tr bgcolor="#f7f7f7">

...
<html>
	<frameset cols="210,*" name="topwin" framespacing="0" border="0"
		frameborder="0">
		<frame
			src="${pageContext.request.contextPath}/bms/adm/showDomainFuncLink.jsp"
		...
		<frameset cols="9,*" framespacing="0" border="0" frameborder="0">
			<frame
				...
				scrolling="auto">
			<frame src="${pageContext.request.contextPath}/bms/adm/showDomainFuncr.jsp"
				name="welcome" noresize marginwidth="0" marginheight="0" id="showDicItem">
		</frameset>
	</frameset>
	<noframes>
		<body>

...
<html>
	<head>
		<title>listBmsAuditdefine</title>
		...
		<script type="text/javascript">
			...
			{
				var url = "${pageContext.request.contextPath}/bms/adm/bmsauditdefine/beforeDeleteBmsAuditdefine.do";
				if(!$chk(id))
				{
			...
			{
				var url = "${pageContext.request.contextPath}/bms/adm/bmsauditdefine/beforeAddBmsAuditdefine.do";
...
<br />
		<ec:table tableId="BmsAuditdefineExList" items="list" var="m" action=""
			...
			<ec:row>
				<ec:column title="PK" property="id"  headerCell="selectAll" alias="ckids" >
					...
					<a
						href="${pageContext.request.contextPath}/bms/adm/bmsauditdefine/detailBmsAuditdefine.do?id=${m.id}">
						${m.id} </a>
				</ec:column>
				...
				<ec:column title="操作" property="EEE" sortable="false"
					filterable="false">
					<a
						href="${pageContext.request.contextPath}/bms/adm/bmsauditdefine/beforeEditBmsAuditdefine.do?id=${m.id}">编辑</a>
					<a

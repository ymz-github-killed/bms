...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			{
				hideframe.location.href="${pageContext.request.contextPath}/bms/adm/bmsrolefunc/deleteBmsRoleFunc.do";
			}
		</script>
	</head>
	<body style="font-size:12px;">
		<div style="text-align: left; background: #f0f0f0; padding: 5px;">
			...
			<a href="${pageContext.request.contextPath}/bms/adm/bmsrolefunc/queryBmsRoleFunc.do">返回</a>
		</div>

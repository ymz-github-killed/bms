...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			{
				hideframe.location.href="${pageContext.request.contextPath}/bms/adm/bmsuserlocations/deleteBmsUserLocations.do";
			}
		</script>
	</head>
	<body style="font-size:12px;">
		<div style="text-align: left; background: #f0f0f0; padding: 5px;">
			...
			<a href="${pageContext.request.contextPath}/bms/adm/bmsuserlocations/queryBmsUserLocations.do">返回</a>
		</div>

...
<html>
	<head>
		...
		<script type="text/javascript">
			function sel(id)
			{
				//parent.main.location.href="${pageContext.request.contextPath}/bms/adm/bmsdept/detailBmsDept.do?id=" + id;
				parent.frames[2].location.href="${pageContext.request.contextPath}/bms/adm/bmsdept/detailBmsDept.do?id=" + id;
			}

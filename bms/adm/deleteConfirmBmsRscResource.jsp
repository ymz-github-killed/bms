...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			{
				hideframe.location.href="${pageContext.request.contextPath}/bms/adm/bmsrscresource/deleteBmsRscResource.do";
			}
		</script>
	</head>
	<body style="font-size:12px;">
		<div style="text-align: left; background: #f0f0f0; padding: 5px;">
			...
			<a href="${pageContext.request.contextPath}/bms/adm/bmsrscresource/queryBmsRscResource.do">返回</a>
		</div>

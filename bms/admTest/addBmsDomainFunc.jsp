						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td height="25" bgcolor="#DDFAFE">
									...
									<span class="font_blue_title">&gt; 新增数据权限</span>
								</td>
							</tr>
						</table>
					</td>
						...
						<table width="98%" border="0" align="center" cellpadding="3"
							...
							<tr bgcolor="#f7f7f7">
								...
								<td align="left" width="35%">
									<input id="code_" type="text" name="code" value="" maxlength="20" class="input3"
								...
								<td align="left" width="35%">
									...
									<input id="datafuncName_" type="text" name="datafuncName" value="" maxlength="20" class="input3"
										size="80" style="width: 200px;height: 16px;" />
								</td>
							</tr>
							...
							<tr bgcolor="#f7f7f7">
								...
								<td align="left" width="35%">
									<input id="domainname_" type="text" name="domainname" readonly="readonly"/>
									<input id="domainid_" type="hidden" name="domainid" readonly="readonly"/>
								...
								<td align="left" width="35%">
									<input id="funcName_" type="text" name="funcName" readonly="readonly"/>
							...
							<tr bgcolor="#f7f7f7">
					            ...
					            <td align="left" colspan="3" >
					            	<textarea name="desc" cols="60" rows="5" id="desc_" class="input_more"></textarea>
					            </td>
					        </tr>

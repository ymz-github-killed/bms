  ...
  <tr>
    ...
    <td width="99%" valign="top">
      ...
      <table width="98%"  border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#dfdfdf">
        <form name="frmApply" action="${pageContext.request.contextPath}/bms/adm/bmslocation/editBmsLocation.do" target="hideframe" method="post" onsubmit="return beforeSubmit(this);">
          <tr bgcolor="#f7f7f7">
            <td width="30%" align="right" class="font_bule2">部门名称：</td>
            <td align="left">
              <input name="name" value="${m.name }" type="text" maxlength="30" class="input3" size="80" style="width:200px " />

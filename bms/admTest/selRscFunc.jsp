...
<!--
	...
	function selRscFunc(id,name)
	{
		parent.selFuncSuc(id,name);
	}
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="border: 1px solid #DDFAFE;">
			<tr>
				<td height="25" bgcolor="#DDFAFE">
								&nbsp;&nbsp;
								<span class="font_blue_title">您所在的位置：权限子系统 &gt; 数据权限管理</span>
								<span class="font_blue_title">&gt; 编辑用户:选择字典权限所属功能</span>
				</td>
			</tr>
			<tr>
				<td valign="top">

					...
					<table width="98%" border="0" align="center" cellpadding="3"
						...
						<tr bgcolor="#f7f7f7">
							...
							<td align="left" width="35%">
								<input id="userLoginName_" type="text" maxlength="20"
									class="input3" size="20" style="width: 200px"
							...
							<td align="left" width="35%">
								<input id="userLoginPassword_" type="password"
									...
									maxlength="20" class="input3" size="20" style="width: 200px" />
									<span style="color: red;">*</span>
							</td>
						</tr>
						<tr bgcolor="#f7f7f7">
						...
						<tr bgcolor="#f7f7f7">
							...
							<td width="15%" align="right" class="font_bule2" rowspan="2">
								备注：
							</td>
							<td align="left" width="35%" rowspan="2">
								<textarea id="userDesc_" name="userDesc" cols="30" rows="3" class="input_more">${m.userDesc}</textarea>
							</td>
						</tr>
						<tr bgcolor="#f7f7f7">
							<td width="15%" align="right" class="font_bule2">
						...
						<tr bgcolor="#f7f7f7">
							...
							<td align="left" width="35%">
								<input id="userEmail_" type="text" name="userEmail"
									value="${m.userEmail}" maxlength="30" class="input3" size="80"
									style="width: 200px" />
								<span style="color: red;">*</span>
							</td>
							<td width="15%" align="right" class="font_bule2">

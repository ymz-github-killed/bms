	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="border: 1px solid #DDFAFE;">
			<tr>
				<td height="25" bgcolor="#DDFAFE">
								&nbsp;&nbsp;
								<span class="font_blue_title">您所在的位置：用户管理子系统 &gt; 角色用户 </span>
								<span class="font_blue_title">&gt; 定义用户角色权限</span>
				</td>
			</tr>
			<tr>
				<td valign="top">
					<form action="${pageContext.request.contextPath}/bms/adm/bmsuserfunc/defineRscForBmsUser.do" method="post" target="hideframe">
						<table width="100%" height="100%" align="center">
							<tr>
								<td>
									<b>请勾选下列权限名称，对用户进行授权:</b>
								</td>		
							</tr>
							<tr valign="top">
								<td valign="top">
							...
							<tr>
								<td align="center">
									<input name="btna1" type="submit" class="button5" value="提交授权" />
									...
									<input name="Button22" type="button" class="button5" value="返回"
										onclick="location.href='${pageContext.request.contextPath}/bms/adm/bmsrole/beforeEditBmsRole.do?id=${roid}'" style="width: 60px;" />
								</td>
							</tr>
						</table>
					</form>

						...
						<table width="98%" border="0" align="center" cellpadding="3"
							...
							<tr bgcolor="#f7f7f7">
								...
								<td align="left" width="35%">
									<input id="auditClsname_" type="text" name="appCode" value="" class="input3" size="20" style="width: 200px;height:16px;"/>
								</td>
								...
								<td align="left" width="35%">
									<input id="appName_" type="text" name="appName" value="" class="input3" size="20" style="width: 200px;height:15px;"/>
								</td>
							</tr>
							...
							<tr bgcolor="#f7f7f7">
								...
								<td align="left" width="35%" colspan="3">
									<input id="appUrl_" type="text" name="appUrl" value="" class="input3" style="width: 350px;height:15px;"/>
								</td>
							</tr>
							...
							<tr bgcolor="#f7f7f7" height="50">
								...
								<td colspan="3" >
									<textarea rows="4" cols="50" name="appDesc" class="input_more"></textarea>
								</td>
							</tr>
							...
							<tr bgcolor="#f7f7f7">
								...
								<td align="left" width="35%" colspan="3">
									<input value="" type="password" name="desKey"  class="input3" size="20" style="width: 360px;height:15px;">
							...
							<tr bgcolor="#f7f7f7">
								...
								<td align="left" width="35%" colspan="3">
									<input id="appUrl_" type="text" name="appIp" value=""  class="input3" size="20" style="width: 360px;height:15px;"/>

	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="border: 1px solid #DDFAFE;">
			<tr>
				<td height="25" bgcolor="#DDFAFE">
								...
								<span class="font_blue_title">&gt; 定义角色权限</span>
				</td>
			</tr>
			<tr>
				<td valign="top">
					<form action="${pageContext.request.contextPath}/bms/adm/bmsrole/defineRscForBmsRole.do" method="post" target="hideframe">
						<table width="100%" height="100%" align="center">
							<tr>
								<td>
									<b>请勾选下列权限名称，对角色进行授权:</b>
								</td>		
							</tr>
							<tr valign="top">
								<td valign="top">

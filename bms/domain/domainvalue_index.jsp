...
<html>
	...
	<frameset cols="210,*" name="topwin" id="topwin" framespacing="0" border="0"
		frameborder="0">
		<frame
			src="${pageContext.request.contextPath}/bms/domain/treeBmsdomainvalue.jsp?domainId=<%=id%>"
		...
		<frameset cols="9,*" framespacing="0" border="0" frameborder="0">
			...
			<frame
				src="${pageContext.request.contextPath}/bms/domain/bmsdomainvalue/queryBmsDomainvalue.do?domainId=<%=id%>"

		...
		<table border="0" width="80%">
			...
			<tr>
				<td width="100%" height="100%">
					...
					<ec:table tableId="underwayList" method="post" items="list" var="m" action=""
							...
							<ec:row>
								...
								<a	href="${pageContext.request.contextPath}/workflow/wfBinding/show.do?type=1&id=${m.entryId}">
									处理					
								</a>
								</ec:column>
							</ec:row>
